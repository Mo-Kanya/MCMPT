...
import kornia
from mvdetr.models.resnet import resnet18
from mvdetr.utils.image_utils import img_color_denormalize, array2heatmap
from mvdetr.utils.projection import get_worldcoord_from_imgcoord_mat, project_2d_points
from mvdetr.models.conv_world_feat import ConvWorldFeat, DeformConvWorldFeat
from mvdetr.models.trans_world_feat import TransformerWorldFeat, DeformTransWorldFeat, \
...
class MVDeTr(nn.Module):
    ...
    def forward(self, imgs, M, visualize=False):
        ...
        if visualize:
            ...
            proj_imgs = kornia.geometry.transform.warp_perspective(T.Resize(self.Rimg_shape)(imgs), proj_mats.to(imgs.device),
        ...
        world_feat = kornia.geometry.transform.warp_perspective(imgs_feat, proj_mats.to(imgs.device),
