...
def main(args):
    ...
    # learn
    # TODO: build gt file to enable MOT eval
    # res_fpath = os.path.join(logdir, 'test.txt')
    res_fpath = None
    best_loss = 99
    if args.resume is None:
        resume = "aug_deform_trans_lr0.0005_baseR0.1_neck128_out0_alpha1.0_id0_drop0.0_dropcam0.0_worldRK4_10_imgRK12_10_2021-08-02_17-28-09"
        model.load_state_dict(torch.load(f'./logs/MMP/{resume}/MultiviewDetector.pth'))
        for epoch in tqdm.tqdm(range(1, args.epochs + 1)):
            ...
            if test_loss <= best_loss:
                ...
                print("Saving best ckpt at epoch", epoch)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_freq', type=int, default=3, help='sampling interval on frames to save time')
