...
def test():
    ...
    print(type(dataset.intrinsic_matrices), type(dataset.extrinsic_matrices))
    print(len(dataset.intrinsic_matrices)) # ()*6
    print(dataset.intrinsic_matrices[0]) # 3*3
    print(dataset.extrinsic_matrices[0]) # 3*4
